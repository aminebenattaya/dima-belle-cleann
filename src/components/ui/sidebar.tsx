...
_Input.displayName = "SidebarInput"
...
_Separator.displayName = "SidebarSeparator"
...
MenuSkeleton.displayName = "SidebarMenuSkeleton"
...
export const SidebarTrigger = Trigger;
export const SidebarRail = Rail;
export const SidebarInset = Inset;
export const SidebarInput = _Input;
...
export const SidebarGroupAction = GroupAction;
export const SidebarGroupContent = GroupContent;
export const SidebarMenu = Menu;
export const SidebarMenuItem = MenuItem;
export const SidebarMenuButton = MenuButton;
export const SidebarMenuAction = MenuAction;
export const SidebarMenuBadge = MenuBadge;
export const SidebarMenuSkeleton = MenuSkeleton;
export const SidebarMenuSub = MenuSub;
export const SidebarMenuSubItem = MenuSubItem;
export const SidebarMenuSubButton = MenuSubButton;
